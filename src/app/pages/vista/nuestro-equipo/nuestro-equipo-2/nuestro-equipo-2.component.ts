...
@Component({
  selector: 'app-nuestro-equipo-2',
  standalone: true,
  imports: [RouterLink, CommonModule, BannerContenido3Component],
  templateUrl: './nuestro-equipo-2.component.html',
  styleUrl: './nuestro-equipo-2.component.css',
})
export class NuestroEquipo2Component implements OnInit {
