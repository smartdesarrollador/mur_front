...
export function contratoPorTemporada(
  ...
  var docDefinition = {
    content: [
      ...
      {
        text: [
          'Conste por el presente documento, el Contrato Individual de Trabajo bajo la modalidad de “Contrato de Temporada”, de conformidad con lo establecido por artículo 67 del Texto Único Ordenado del Decreto Legislativo 728 – Ley de Productividad y Competitividad Laboral aprobado por el Decreto Supremo N.º 003-97-TR, de una parte,\n\n',
        ],
        style: 'parrafo',
      },
      {
      ...
      {
        text: [
          '1.4.	En virtud de los antecedentes señalados, LAS PARTES acuerdan celebrar el presente contrato bajo la modalidad temporal de necesidad de mercado contemplada en el artículo 67 del Texto Único Ordenado de la Ley de Productividad y Competitividad Laboral – LPCL – para que desempeñe la realización de funciones descritas en el Anexo 1-A del presente contrato. \n\n',
        ],
        style: 'parrafo',
      },
      {
