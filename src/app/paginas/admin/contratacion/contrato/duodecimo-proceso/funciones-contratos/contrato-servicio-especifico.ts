...
export function contratoServicioEspecifico(
    ...
    content: [
      ...
      },
      {
        text: [
          ...
          ' del Registro de Personas Jurídicas de la Oficina Registral Lima.\n\n',
        ],
        style: 'parrafo',
      },
      {
      ...
      },
      {
        text: [
          ...
          { text: datosLocales.oferta_laboral, style: 'datos_locales' },
          '   que ocupará EL TRABAJADOR, los servicios descritos en la cláusula tercera del presente contrato, serán prestados en las instalaciones de EL EMPLEADOR ubicada en ',
          {
            text: registroEmpleador.oficina_registral,
            style: 'datos_locales',
          },
      ...
      datosLocales.jornada_maxima
        ? {
            text: [
              ...
              ', incluida una hora de refrigerio (los cuales no forman parte de la jornada ni del horario de trabajo); pudiendo ser modificado ajustándolo a la jornada máxima legal permitida, sin que dichas modificaciones impliquen en EL TRABAJADOR menoscabo de su categoría y/o remuneración.  \n\n',
            ],
            style: 'parrafo',
          }
        : null,
