  ...
  var docDefinition = {
    content: [
      ...
      datosLocales.jornada_maxima
        ? {
            text: [
              'El horario de trabajo será distribuido de lunes a viernes pudiendo ser la jornada laboral de lunes a viernes de ',
              datosLocales.horario_inicio,
              ' a ',
              datosLocales.horario_final,
              ', incluido los 60 minutos de refrigerio, los cuales no forman parte de la jornada ni del horario de trabajo.  \n\n',
            ],
            style: 'parrafo',
          }
        : null,
      ...
      {
        text: [
          'En atención al artículo 10 del Texto Único Ordenado del Decreto Legislativo 728 – Ley de Productividad y Competitividad Laboral aprobado por el Decreto Supremo N.º 003-97-TR, el período de prueba es de',
          prueba_meses,
          ' meses, el cual empieza el ',
          prueba_inicio,
          ' y termina el ',
          prueba_termino,
